...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const SplashScreen(), // Changed to show splash screen first
      routes: {
...
class SplashScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedSplashScreen(
      ...
      backgroundColor: const Color(0xFF210F04), // matching app background
      duration: 3300, // 3-5 seconds (adjust as needed)
      splashIconSize:
          double.infinity, // make the GIF fill the screen completely
    );
  }
}
