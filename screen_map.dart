            ...
            builder: (context, AsyncSnapshot<List<dynamic>> snapshot) {
              ...
              return Column(
                children: levelDocs.docs.map((doc) {
                  ...
                  final color = unlocked ? const Color(0xFF3A9D5D) : const Color(0xFF888888);
                  ...
                  return GestureDetector(
                    onTap: unlocked
                        ? () {
                            // make sure to navigate to actual game screen
                            Navigator.push(context, MaterialPageRoute(builder: (context) => const Level1LessonPage()));
